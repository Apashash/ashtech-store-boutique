...
<head>
    ...
    <title>Détails du produit | ASHTECH STORE</title>
            ...
            <div class="mt-10 p-6 bg-gray-50 rounded-xl shadow-sm border border-gray-100 relative overflow-hidden fade-in">
                <div class="relative z-10">
                    <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                        <div class="md:w-2/3">
                            <h3 class="text-2xl font-bold mb-4 text-gray-800">La Garantie ASHTECH STORE</h3>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="https://wa.me/237683677872" class="group">
