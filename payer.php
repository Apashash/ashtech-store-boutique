...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $return_url = "https://ashtechstore.iceiy.com/merci.php";
    $webhook_url = "https://ashtechstore.iceiy.com/webhook.php";
    ...
    $ch = curl_init("https://www.pay.moneyfusion.net/Ashtech_store/379561db83262b9a/pay/");
...
<head>
    ...
    <title>Finaliser votre achat | ASHTECH STORE</title>
...
<body class="bg-white font-sans leading-normal tracking-normal text-gray-800 transition-colors duration-300 min-h-screen">
    ...
    <nav class="fixed top-0 w-full bg-white shadow-sm z-50">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            <a href="index.php" class="flex items-center space-x-2 group">
                ...
                <span class="font-bold text-xl text-gray-800">ASHTECH STORE</span>
            </a>
    ...
    <span>
        ...
        Exemple : <strong>+237xxxxxxxx</strong>
    </span>
</p>
    ...
    <footer class="bg-gray-800 text-white py-12">
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="text-center md:text-left mb-6 md:mb-0">
                    <div class="flex items-center justify-center md:justify-start">
                        ...
                        <h2 class="text-2xl font-bold">ASHTECH STORE</h2>
                    </div>
                    <p class="text-gray-400 mt-2">Solutions digitales premium pour votre réussite</p>
                </div>
                
                <div class="flex space-x-4">
                    <a href="https://www.facebook.com/share/1ZXcBAwyvT/?mibextid=wwXIfr" class="group">
                    ...
                    <a href="https://www.instagram.com/alassanash?igsh=emN2M2tqejY4OWYy&utm_source=qr" class="group">
                    ...
                    <a href="https://wa.me/message/DMFH6M4PXGDBA1" class="group">
            ...
            <div class="text-center text-gray-400 text-sm">
                <p>&copy; 2025 ASHTECH STORE. Tous droits réservés.</p>
