...
<head>
    ...
    <title>Merci pour votre achat | ASHTECH STORE</title>
    ...
    <nav class="fixed top-0 w-full bg-white shadow-md z-50 dark:bg-gray-800">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            <a href="index.php" class="flex items-center space-x-2 group">
                ...
                <span class="font-bold text-xl bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary">ASHTECH STORE</span>
            </a>
                ...
                <div class="flex flex-col md:flex-row items-center">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            <a href="https://wa.me/message/DMFH6M4PXGDBA1" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-700 text-green-600 dark:text-green-400 rounded-lg shadow hover:shadow-md transition-all duration-300">
