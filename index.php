  ...
  <div class="absolute inset-0 flex items-center justify-start px-4 md:px-16">
    <div class="bg-white/30 backdrop-blur-sm rounded-2xl shadow-xl p-6 md:p-10 max-w-xl text-left">
      <h1 class="text-3xl md:text-5xl font-extrabold text-gray-900 mb-4 leading-tight drop-shadow-md">
        Bienvenue chez <span class="text-secondary">ASHTECH STORE</span>
      </h1>
...
<a href="https://wa.me/message/DMFH6M4PXGDBA1" target="_blank"
   class="bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-6 rounded-xl shadow hover:shadow-2xl transform hover:-translate-y-1 transition">
...
<div class="px-6 mb-12 text-center">
  ...
  <a href="https://wa.me/237683677872" target="_blank" class="floating-whatsapp bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition">
  ...
  <footer class="bg-gray-900 text-gray-400 pt-12 pb-8 mt-auto">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        <div>
          <h3 class="text-white text-lg font-semibold mb-4">ASHTECH STORE</h3>
      ...
      <div class="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
        <p class="text-sm">&copy; <?= date('Y') ?> ASHTECH STORE. Tous droits réservés.</p>
